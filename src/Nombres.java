...
public class Nombres {
    // Lista tomada de aquí: https://github.com/olea/lemarios/blob/master/nombres-propios-es.txt
    private String[] nombres = {"Aarón",
            "Abdón",
            "Abel",
            "Abelardo",
            "Abrahán",
    ...
    public String getNombreAleatorio(){
        ...
        int aleatorio = random.nextInt(nombres.length);
